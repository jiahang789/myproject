...
<div>
     <el-card class="box-card" shadow="always">
        ...
        <el-table :data="tableData" style="width: 85%"  tooltip-effect="dark" border>
          ...
          <el-table-column sortable label="备件名称" width="180" prop="teDescribe" align="center"> </el-table-column>
           <el-table-column sortable  label="设备" width="190" prop="emType" align="center"> </el-table-column>
          <el-table-column sortable  label="库存" width="180" prop="emType" align="center"> </el-table-column>
           <el-table-column sortable label="入库数量" width="180" prop="emModei" align="center"></el-table-column>
  </el-table>
   <!-- <el-pagination background
     ...
     <el-button type="success" size="mini" style="margin-left: 79%;margin-top:7px" >入 库</el-button>
    </el-card>
</div>
</template>
