...
<div>
     <el-card class="box-card" shadow="always">
        ...
        <el-table :data="tableData" style="width: 82%"  tooltip-effect="dark" border>
             <!-- <el-table-column type="selection" width="40"></el-table-column> -->
               <el-table-column label="序号" width="60" prop="emId" align="center"> </el-table-column>
          <el-table-column sortable label="工装编号" width="162" prop="emName" align="center"> </el-table-column>
          ...
          <el-table-column sortable  label="上次更换时间" width="150" prop="emType" align="center"> </el-table-column>
           <el-table-column sortable label="上次更换原因" width="150" prop="emModei" align="center"></el-table-column>
           <el-table-column sortable label="更换原因" width="150" prop="emModei" align="center"></el-table-column>
  </el-table>
   <!-- <el-pagination background
     ...
     <el-button type="success" size="mini" style="margin-left: 76%; margin-top:7px" >更 换</el-button>
    </el-card>
</div>
</template>
