...
<div>
     <el-card class="box-card" shadow="always">
        ...
        <el-table :data="tableData" style="width: 99%"  tooltip-effect="dark" @selection-change="handleSelectionChange" border>
          ...
          <el-table-column sortable label="申请单号" width="185" prop="emName" align="center"> </el-table-column>
          ...
          <el-table-column sortable  label="库存" width="130" prop="emType" align="center"> </el-table-column>
           <el-table-column sortable label="领用数量" width="130" prop="emModei" align="center"></el-table-column>
   ...
   <!-- <el-pagination background
    ...
    <el-button type="success" size="mini" style="margin-left: 94%; margin-top:7px" >出 库</el-button>
    </el-card>
</div>
</template>
