...
<div>
     <el-card class="box-card" shadow="always">
        ...
        <el-table :data="tableData" style="width: 85%"  tooltip-effect="dark" border>
          ...
          <el-table-column sortable label="备件编号" width="180" prop="emName" align="center"> </el-table-column>
           <el-table-column sortable label="备件名称" width="160" prop="emNum" align="center"></el-table-column>
